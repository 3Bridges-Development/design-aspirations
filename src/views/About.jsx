        ...
        <>
            <section>
                ...
                <div className="bg-da-black md:px-8 p-2 pt-8 pb-8 flex flex-col items-center">
                    ...
                    <h2 className="text-da-white w-3/5 text-lg pt-4">At Designed Aspirations, we are committed to helping others Aspire to Be; Aspire to Do; Aspire to Learn, Aspire to Achieve, and Aspire to Dream.</h2>
                </div>
                <div className="bg-da-black md:px-8 p-2 pb-8 flex flex-col items-center">
                    ...
                    <h2 className="text-da-white w-3/5 text-lg pt-4">Designed Aspirations start may sound familiar. At some point in life, many find themselves unsure of their purpose. Reflecting on experiences, hosts of skillsets, achievements, and what felt the most fulfilling in their career.</h2>
                    <h2 className="text-da-white w-3/5 text-lg pt-4">I realized that I've always been passionate about wellness, education, and training personally and professionally. That realization, coupled with a sincere desire to help people, is how Designed Aspirations came to be.</h2>
