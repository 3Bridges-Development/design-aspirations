        ...
        <>
            <section className="flex justify-center p-2 relative flex-wrap md:m-0 m-1">
                ...
                <div className="flex items-center">
                    <button className="md:absolute md:bottom-30 bg-da-black text-da-yellow p-2 max-h-10 hover:text-blue-200" type="button" onClick={console.log("clicked!")}>BOOK CONSULTATION</button>
                </div>
                <hr className="p-1 mt-8 bg-da-black w-4/5 rounded-md"></hr>
            </section>
            <section className="flex flex-col items-center md:m-0 m-1">
                <h2 className="text-da-burgundy text-2xl">Designed Aspirations offer Instructional Design and Development of educational and training material.</h2>
